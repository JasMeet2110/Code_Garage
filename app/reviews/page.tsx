...
const Star = ({ filled }: { filled: boolean }) => (
  <span className={`text-xl ${filled ? 'opacity-100' : 'opacity-40'}`}>★</span>
)
    ...
    <div className="mt-32 px-6 md:px-10 mb-40">
      <div className="w-full max-w-6xl mx-auto flex flex-col gap-8">
        <section className="bg-white text-black rounded-xl shadow-md p-6">
          ...
          <p className="opacity-80">Read what customers say and leave your review.</p>
        </section>
        ...
        <section className="bg-white text-black rounded-xl shadow-md p-6">
          ...
          <div className="mt-4 flex gap-2">
            <button className="nav-btn" onClick={() => { setName(''); setRating(0); setComment('') }}>
              Cancel
            </button>
            <button
